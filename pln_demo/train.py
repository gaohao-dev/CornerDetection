...
# Data parameters
data_folder = '/home/haogao/works/PLN/vocdata/jsonfiles/'  # data files root path
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (images, boxes, labels, _) in enumerate(train_loader):
        ...
        # Forward prop.
        predicted_locs, predicted_scores, p, q, xy, linkx, linky = model(images)  # (N, 441, 4), (N, 441, n_classes)

        # Loss
        loss = criterion(predicted_locs, predicted_scores, p, q, xy, linkx, linky, boxes, labels)  # scalar
